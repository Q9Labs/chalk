...
if (__ENV.DEBUG_ENV === "true") {
  console.log(`DEBUG_ENV BASE_URL=${BASE_URL} WS_URL=${WS_URL} TENANT_ID=${testTenant.id} API_KEY=${testTenant.apiKey} ACTIVE_USERS=${ACTIVE_USERS} ROOM_SIZE=${ROOM_SIZE} SHORT=${SHORT_RUN} EXPECT_RATE_LIMIT=${EXPECT_RATE_LIMIT}`);
}
