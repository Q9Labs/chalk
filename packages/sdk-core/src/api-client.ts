...
export class APIClient {
  ...
  // Room endpoints
  async createRoom(name?: string, config?: Record<string, unknown>): Promise<ApiResponse<CreateRoomResponse>> {
    return this.request<CreateRoomResponse>('POST', '/api/v1/rooms', { name, config });
  }
  ...
  async addParticipant(
    ...
    return this.request<JoinRoomResponse>('POST', `/api/v1/rooms/${roomId}/participants`, {
      displayName,
      role,
      metadata,
    });
