...
const mergeProperties = (base?: Record<string, unknown>, extra?: Record<string, unknown>): Record<string, unknown> | undefined => {
...
export class ChalkPostHogSessionReplay {
  ...
  private capture(eventSuffix: string, properties?: Record<string, unknown>): void {
