...
export { getParticipantAvatarGradient, getParticipantAvatarRecipe, getParticipantBorder, getParticipantColor, getParticipantGradient, getParticipantInitial, getParticipantInitials, getParticipantThemeVariables, PARTICIPANT_GRADIENT_PRESETS } from "./utils/participant-colors.ts";
...
export { clientMessageTypeMap, serverMessageTypeMap } from "./types/events/client-events.ts";

// WebSocket schema maps (runtime validation + inferred types)
export { WSOutboundPayloadSchemas, type WSOutboundMessageType } from "./effect/schemas/index.ts";
...
export type { WideEvent, WideEventConfig, WideEventError, WideEventOutcome, WideEventPlatform, WideEventSdk, WideEventType } from "./wide-events/index.ts";
...
export { buildStructuredDebugReport, type BuildStructuredDebugReportInput } from "./debug/report-v2.ts";
export {
