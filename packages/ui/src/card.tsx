...
function Card({ className, size = "default", ...props }: React.ComponentProps<"div"> & { size?: "default" | "sm" }) {
  return <div data-slot="card" data-size={size} className={cn("bg-card text-card-foreground border rounded-xl shadow-sm flex flex-col overflow-hidden", className)} {...props} />;
}
