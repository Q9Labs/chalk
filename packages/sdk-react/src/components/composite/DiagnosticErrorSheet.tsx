...
export const DiagnosticErrorSheet = React.memo<DiagnosticErrorSheetProps>(({
  ...
  return (
    <div 
      className={cn(
        "fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-6 bg-black/40 backdrop-blur-sm animate-in fade-in duration-300",
        className
      )}
    >
      <div 
      ...
      <div 
        className={cn(
          "relative w-full max-w-lg bg-background border-t sm:border border-border shadow-2xl overflow-hidden animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-8 sm:zoom-in-95 duration-500 ease-out sm:rounded-3xl",
          "rounded-t-[32px]"
        )}
        style={{
        ...
        <div className="px-8 pt-8 pb-10 flex flex-col items-center text-center">
          ...
          <div className="w-full mb-8">
            <button
              ...
              className="flex items-center gap-2 mx-auto text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/50 hover:text-foreground transition-all duration-200 group"
            >
