						...
						{isEditing ? (
							<div className="flex items-center gap-1 flex-1">
								<input
									...
									onBlur={handleSave}
									className={cn(
										'text-sm font-normal bg-background border border-primary/30 rounded px-1.5 py-0.5 outline-none w-full min-w-0 focus:border-primary',
							...
							<span
								className={cn(
									'text-sm font-normal truncate max-w-[140px]',
									variant === 'sidebar' ? 'text-card-foreground' : 'text-chalk-text-primary',
								)}
							...
							<>
								...
								>
									<ParticipantOptionsMenu
										...
										onEditName={participant.isLocal ? () => { setIsEditing(true); onMenuClose(); } : undefined}
