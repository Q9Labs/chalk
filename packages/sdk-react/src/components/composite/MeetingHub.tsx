...
export const MeetingHub = React.memo<MeetingHubProps>(({
  ...
  return (
    <div className={cn(
      "fixed bottom-24 left-6 z-50 w-[360px] overflow-hidden rounded-[28px] border border-white/10 bg-zinc-950/95 backdrop-blur-3xl shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] animate-in fade-in slide-in-from-bottom-8 duration-500 ease-out",
      className
    )}>
      {/* Premium Header */}
      <div className="relative px-6 py-5 border-b border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent">
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            ...
            <p className="text-[11px] font-bold text-white/30 uppercase tracking-widest tabular-nums">
              Session Live • {formatDuration(meetingDuration)}
            </p>
          </div>
          <button 
            onClick={onClose}
            className="rounded-full p-2.5 text-white/20 hover:bg-white/5 hover:text-white transition-all duration-300"
          >
      ...
      <div className="p-2">
        <div className="flex p-1 rounded-2xl bg-white/[0.03] border border-white/5">
          <button
            ...
            className={cn(
              "flex-1 flex items-center justify-center gap-2 px-4 py-2.5 text-[12px] font-bold rounded-xl transition-all duration-300",
              activeTab === "details" 
                ? "bg-white/10 text-white shadow-[0_4px_12px_rgba(0,0,0,0.2)]" 
            ...
            <div className="flex items-center gap-4 rounded-3xl bg-primary/5 p-4 border border-primary/10">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[11px] font-medium text-white/30">
                  Media streams are encrypted via RealtimeKit.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-7 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-2xl font-bold text-white tabular-nums">{stats.latency}<span className="text-xs ml-1 text-white/30 font-bold uppercase">ms</span></p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-white/20">
