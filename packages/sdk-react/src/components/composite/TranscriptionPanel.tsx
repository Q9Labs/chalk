  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {isOpen && (
        <div
          className={cn(
            "absolute right-0 top-full mt-1 z-50 min-w-[140px] rounded-lg shadow-lg border",
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
      ...
      <p className="text-sm text-muted-foreground max-w-[200px]">
        Transcription will appear as people speak
      </p>
...
export const TranscriptionPanel = React.memo(({
  ...
  const searchMatches = useMemo(
    () => findSearchMatches(transcripts, searchQuery),
  ...
  const groupedTranscripts = useMemo(
    () => groupTranscriptsBySpeaker(filteredTranscripts),
    [filteredTranscripts]
  );
    ...
    return (
      <div className="relative flex-1">
        ...
        <input
          ...
          className={cn(
            "w-full h-8 pl-8 pr-8 text-sm rounded-lg border bg-background/50",
    ...
    return (
      <div className="sticky bottom-0 flex justify-center pb-2 pointer-events-none">
        <button
          ...
          className={cn(
            "px-3 py-1.5 rounded-full text-xs font-medium shadow-lg flex items-center gap-1.5 pointer-events-auto transition-all",
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-2 px-6 pb-4">
          ...
          {renderSearchNav()}
          {(onExport || onCopyAll) && (
            <ExportDropdown onExport={onExport} onCopyAll={handleCopyAll} />
          )}
        </div>
