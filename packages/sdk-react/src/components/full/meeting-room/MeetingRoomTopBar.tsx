            ...
            <div className="flex items-center gap-1 max-w-0 overflow-hidden opacity-0 group-hover:max-w-[200px] group-hover:opacity-100 group-focus-within:max-w-[200px] group-focus-within:opacity-100 transition-all duration-300 ease-in-out">
                ...
                <TooltipTrigger
                  render={
                    <button
                      ...
                      className="flex items-center justify-center rounded-md w-7 h-7 text-white/80 hover:text-white hover:bg-white/10 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary"
              ...
              {layout !== "grid" && (
                <Tooltip>
                  <TooltipTrigger
                    render={
                      <button type="button" onClick={() => setLayout("grid")} className="flex items-center justify-center rounded-md w-7 h-7 text-white/80 hover:text-white hover:bg-white/10 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary" aria-label="Grid layout">
