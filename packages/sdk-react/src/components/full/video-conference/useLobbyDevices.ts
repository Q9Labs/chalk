...
export function useLobbyDevices({
	...
	selectedMicrophone,
	selectedSpeaker,
}: UseLobbyDevicesParams): UseLobbyDevicesReturn {
	const [lobbySelectedCamera, setLobbySelectedCamera] = useState<string | undefined>(
		undefined,
	);
	const [lobbySelectedMicrophone, setLobbySelectedMicrophone] = useState<
		string | undefined
	>(undefined);
	const [lobbySelectedSpeaker, setLobbySelectedSpeaker] = useState<string | undefined>(
		undefined,
	);
