...
export function useConferenceConnectionState({ status, phase, isConnected, isDisconnectGraceActive, setPhase }: UseConferenceConnectionStateParams): UseConferenceConnectionStateReturn {
