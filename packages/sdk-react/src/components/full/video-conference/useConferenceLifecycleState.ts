...
export function useConferenceLifecycleState({ phase, status, roomId, localParticipantId }: UseConferenceLifecycleStateParams): UseConferenceLifecycleStateReturn {
