...
function PreJoinLobbyBase({
  ...
  const resolvedUserName = settings.identity.displayName.trim() || userName;
  const resolvedInitialVideoEnabled = initialVideoEnabled || settings.join.videoEnabled;
  const resolvedInitialAudioEnabled = initialAudioEnabled || settings.join.audioEnabled;
  ...
  const ui = usePreJoinUiState({
    ...
    error,
    initialVideoEnabled: resolvedInitialVideoEnabled,
    initialAudioEnabled: resolvedInitialAudioEnabled,
    initialShowSettings,
  ...
  const handleJoin = useCallback(() => {
    updateIdentitySettings({
      displayName: ui.displayName.trim(),
    });
    updateJoinSettings({
      audioEnabled: ui.isAudioEnabled,
      videoEnabled: ui.isVideoEnabled,
    });
    ...
    ui.handleJoin();
  }, [enablePictureInPicture, settings.experience.autoOpenPictureInPicture, ui.displayName, ui.handleJoin, ui.isAudioEnabled, ui.isVideoEnabled, updateIdentitySettings, updateJoinSettings]);
