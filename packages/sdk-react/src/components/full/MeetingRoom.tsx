...
function MeetingRoomBase({
  ...
  const hasDebugTrigger = typeof onOpenDebug === "function";
  ...
  useHotkey("Alt+Shift+D", handleOpenDebug, {
    enabled: hasDebugTrigger && !ui.isExiting,
    ignoreInputs: true,
    preventDefault: true,
  });

  useHotkey("Mod+D", handleOpenDebug, {
    enabled: hasDebugTrigger && !ui.isExiting,
    ignoreInputs: true,
    preventDefault: true,
  });
    ...
    >
      ...
      <div className={cn("relative z-10 w-full", !reduceMotion && "animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out fill-mode-both delay-300")}>
        <MeetingRoomControls
          ...
          onOpenDiagnostics={hasDebugTrigger ? handleOpenDebug : undefined}
          isExiting={ui.isExiting}
          localParticipantColorSeed={participantColorSeed}
          localParticipantGradientPreference={localParticipantGradientPreference}
        />
