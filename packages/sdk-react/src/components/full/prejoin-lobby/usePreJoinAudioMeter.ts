...
export function usePreJoinAudioMeter({ track, isAudioEnabled, externalAudioLevel }: UsePreJoinAudioMeterParams): UsePreJoinAudioMeterReturn {
  ...
  useEffect(() => {
    ...
    const AudioContextCtor = (globalThis as { AudioContext?: typeof AudioContext; webkitAudioContext?: typeof AudioContext }).AudioContext ?? (globalThis as { AudioContext?: typeof AudioContext; webkitAudioContext?: typeof AudioContext }).webkitAudioContext;
