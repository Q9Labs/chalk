 ...
 * ```
 */
export const WhatsNewTrigger = React.memo<WhatsNewTriggerProps>(
	({ hasUnseen = false, onClick, className, size = "md" }) => {
				...
				{hasUnseen && (
					<span
						className={cn(
							...
							isSmall ? "top-1 right-1 h-2 w-2" : "top-1.5 right-1.5 h-2.5 w-2.5"
						)}
