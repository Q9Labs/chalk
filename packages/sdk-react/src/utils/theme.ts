...
export const resolveThemeFromDocument = ({
	defaultTheme = "light",
	allowSystem = true,
}: ResolveThemeOptions = {}): ThemeMode => {
	if (typeof document === "undefined") return defaultTheme;

	const explicitTheme =
		resolveThemeFromElement(document.documentElement) ??
		resolveThemeFromElement(document.body);
...
export const subscribeToThemeChanges = (
	onThemeChange: (theme: ThemeMode) => void,
	{
		defaultTheme = "light",
		allowSystem = true,
		attributes = ["class", ...THEME_ATTRIBUTE_NAMES],
