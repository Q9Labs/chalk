...
describe("ReactionPicker", () => {
  ...
  it("renders when open", () => {
    const { getByLabelText } = render(<ReactionPicker isOpen={true} onClose={() => {}} onSelect={() => {}} />);
  ...
  it.skip("calls onSelect when emoji clicked", () => {
    ...
    const { getByLabelText } = render(<ReactionPicker isOpen={true} onClose={() => {}} onSelect={onSelect} />);
  ...
  it.skip("shows recent reactions", () => {
    const { getByText } = render(<ReactionPicker isOpen={true} onClose={() => {}} onSelect={() => {}} recentReactions={["🔥"]} />);
    expect(getByText("Recent")).toBeDefined();
    expect(getByText("🔥")).toBeDefined();
  });

  it("returns null when closed", () => {
    const { container } = render(<ReactionPicker isOpen={false} onClose={() => {}} onSelect={() => {}} />);
