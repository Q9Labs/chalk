...
describe('BackgroundEffectsPicker', () => {
  ...
  it('renders all effect options', () => {
    const { getByLabelText } = render(
      <BackgroundEffectsPicker effects={effects} onSelect={() => {}} />
    );
  ...
  it('calls onSelect when an effect is clicked', () => {
    ...
    const { getByLabelText } = render(
      <BackgroundEffectsPicker effects={effects} onSelect={onSelect} />
    );
  ...
  it('calls onCustomUpload when a file is selected', () => {
    ...
    const { getByLabelText, container } = render(
      <BackgroundEffectsPicker effects={[]} onSelect={() => {}} onCustomUpload={onCustomUpload} />
    );
