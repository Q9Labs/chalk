...
import { ChalkProvider, useChalk, type ChalkProviderProps } from '../context.tsx';
...
describe('ChalkProvider and useChalk', () => {
  ...
  describe('context value structure', () => {
    it('should have all required context properties', () => {
      const requiredProps = ['client', 'room', 'isConnected', 'connectionStatus', 'joinRoom', 'leaveRoom', 'createRoom'];
