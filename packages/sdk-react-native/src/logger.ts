...
const isIOSSimulator = Platform.OS === "ios" && ((Platform.constants as Record<string, unknown>)?.isTesting === true || (NativeModules.PlatformConstants as Record<string, unknown>)?.isSimulator === true || __DEV__);
