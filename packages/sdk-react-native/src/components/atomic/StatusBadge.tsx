...
import { MutedIcon as MuteIcon, SpeakingIcon as VolumeIcon, HandRaisedIcon as HandIcon } from "../../icons";
...
export function StatusBadge({ type, size = 24, style }: StatusBadgeProps) {
  ...
  return (
    <View style={[styles.container, containerStyle, style]}>
      {type === "muted" && <MuteIcon size={iconSize} color={CHALK_THEME.colors.text.primary} />}
      {type === "speaking" && <VolumeIcon size={iconSize} color={CHALK_THEME.colors.text.primary} />}
      {type === "hand.raised" && <HandIcon size={iconSize} color={CHALK_THEME.colors.text.primary} />}
    </View>
  );
}
