...
export function NativeMeetingBottomDockIosPhone({ simulatorMediaDisabled, isMuted, isCameraOff, unreadChatCount, onToggleAudio, onToggleVideo, onOpenChat, onOpenMore, onLeave }: NativeMeetingBottomDockProps): React.JSX.Element {
  return (
