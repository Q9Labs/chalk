    ...
    <View style={styles.bottomDock}>
      <View style={styles.controlPill}>
        ...
        <View style={styles.group}>
          <Pressable disabled={simulatorMediaDisabled} onPress={onToggleAudio} style={({ pressed }) => [styles.controlButton, isMuted && styles.buttonDanger, simulatorMediaDisabled && styles.buttonDisabled, pressed && styles.buttonPressed]}>
            <HugeiconsIcon color="white" icon={isMuted ? MicOff01Icon : Mic01Icon} size={22} />
          </Pressable>

          <Pressable disabled={simulatorMediaDisabled} onPress={onToggleVideo} style={({ pressed }) => [styles.controlButton, isCameraOff && styles.buttonDanger, simulatorMediaDisabled && styles.buttonDisabled, pressed && styles.buttonPressed]}>
            <HugeiconsIcon color="white" icon={isCameraOff ? VideoOffIcon : Video01Icon} size={22} />
          </Pressable>

          <Pressable onPress={onToggleScreenShare} style={({ pressed }) => [styles.controlButton, styles.secondaryButton, isScreenSharing && styles.buttonActive, pressed && styles.buttonPressed]}>
            <HugeiconsIcon color={isScreenSharing ? Theme.colors.primary : "white"} icon={ComputerScreenShareIcon} size={22} />
          </Pressable>

          <Pressable onPress={onToggleHand} style={({ pressed }) => [styles.controlButton, styles.secondaryButton, isHandRaised && styles.buttonWarning, pressed && styles.buttonPressed]}>
        ...
        <View style={styles.group}>
          <Pressable onPress={onOpenParticipants} style={({ pressed }) => [styles.controlButton, styles.secondaryButton, pressed && styles.buttonPressed]}>
        ...
        {/* System & Exit Group */}
        <View style={styles.group}>
          <Pressable onPress={onOpenMore} style={({ pressed }) => [styles.controlButton, styles.secondaryButton, pressed && styles.buttonPressed]}>
            <HugeiconsIcon color="white" icon={MoreHorizontalIcon} size={22} />
          </Pressable>

          <Pressable onPress={onLeave} style={({ pressed }) => [styles.controlButton, styles.exitButton, pressed && styles.buttonPressed]}>
