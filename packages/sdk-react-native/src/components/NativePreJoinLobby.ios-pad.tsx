    ...
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.screen}>
      ...
      <View style={styles.immersiveContainer}>
        {controller.previewStream && controller.videoEnabled ? (
          <RTCView 
            mirror 
            objectFit="cover" 
            streamURL={controller.previewStream.toURL()} 
      ...
      <View style={styles.hudLayer}>
        ...
        >
          ...
          <View style={styles.launchPad}>
            ...
            <View style={styles.mediaGroup}>
              <Pressable 
                ...
                style={({ pressed }) => [
                  styles.mediaToggle, 
                  !controller.audioEnabled && styles.toggleOff,
                  pressed && styles.pressed
                ]}
              >
                <HugeiconsIcon 
                  icon={controller.audioEnabled ? Mic01Icon : MicOff01Icon} 
                  size={22} 
                  color="white" 
                />
              </Pressable>
              <Pressable 
                ...
                style={({ pressed }) => [
                  styles.mediaToggle, 
                  !controller.videoEnabled && styles.toggleOff,
                  pressed && styles.pressed
                ]}
              >
                <HugeiconsIcon 
                  icon={controller.videoEnabled ? Video01Icon : VideoOffIcon} 
                  size={22} 
                  color="white" 
                />
              </Pressable>
          ...
          {controller.simulatorMediaDisabled && (
            <Text style={styles.simulatorHintText}>{getIosSimulatorMediaMessage()}</Text>
          )}
        </Animated.View>
      </View>
