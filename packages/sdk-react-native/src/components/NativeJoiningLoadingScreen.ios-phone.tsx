...
export function NativeJoiningLoadingScreenIosPhone({ displayName, message = "Joining room...", supportingMessages = [] }: NativeJoiningLoadingScreenProps): React.JSX.Element {
