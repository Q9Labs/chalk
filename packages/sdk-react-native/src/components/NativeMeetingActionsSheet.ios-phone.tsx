...
function NativeMeetingActionsSheetIosPhoneBase({
  visible,
  isHandRaised,
  isScreenSharing,
  chatEnabled,
              ...
              <View style={styles.sectionsContainer}>
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.grid}>
                    ...
                    {onOpenWhiteboard && <ActionTile disabled={!whiteboardEnabled} icon={Presentation01Icon} label="Whiteboard" onPress={onOpenWhiteboard} />}
