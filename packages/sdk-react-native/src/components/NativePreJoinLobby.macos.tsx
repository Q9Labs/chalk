...
export function NativePreJoinLobbyMacos({ roomName, error, joinDisabled = false, onCancel, ...props }: NativePreJoinLobbyProps): React.JSX.Element {
      ...
      <View style={styles.content}>
        <View style={styles.previewContainer}>
          <View style={styles.previewSurface}>
            {previewStreamURL ? (
              <NativeRtcVideoView mirror objectFit="cover" streamURL={previewStreamURL} style={styles.previewVideo} zOrder={0} />
            ) : (
