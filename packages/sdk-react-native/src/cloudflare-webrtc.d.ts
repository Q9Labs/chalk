...
declare module "@cloudflare/react-native-webrtc" {
  ...
  export const RTCView: React.ForwardRefExoticComponent<RTCViewProps & React.RefAttributes<unknown>>;
}
...
declare module "@cloudflare/realtimekit-react-native" {
  ...
  export function useRealtimeKitClient(): [RealtimeKitClient | undefined, (options: RealtimeKitClientOptions) => void];

  export function useRealtimeKitSelector<StateSlice>(selector: (state: RealtimeKitClient) => StateSlice): StateSlice;

  export function useRealtimeKitMeeting(): {
    meeting: RealtimeKitClient;
  };

  export function RealtimeKitProvider(props: { value: RealtimeKitClient | undefined; children: ReactNode; fallback?: ReactNode }): JSX.Element;
