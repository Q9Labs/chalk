...
CODEGEN_SYNC_PROTOCOL_VERSION=2 node tools/contract-codegen/src/emitters/sync-typescript.mjs
CODEGEN_SYNC_PROTOCOL_VERSION=2 node tools/contract-codegen/src/emitters/sync-elixir.mjs
...
pnpm exec oxfmt --write \
  ...
  sdks/typescript/client/src/generated/sync-v2.ts \
