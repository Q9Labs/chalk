...
CODEGEN_SYNC_PROTOCOL_VERSION=2 \
CODEGEN_SYNC_TYPESCRIPT_OUTPUT_PATH="$tmpdir/sync-v2.ts" \
  node tools/contract-codegen/src/emitters/sync-typescript.mjs

CODEGEN_SYNC_PROTOCOL_VERSION=2 \
CODEGEN_SYNC_ELIXIR_OUTPUT_PATH="$tmpdir/generated_v2.ex" \
  node tools/contract-codegen/src/emitters/sync-elixir.mjs
...
diff -u sdks/typescript/client/src/generated/sync-v2.ts "$tmpdir/sync-v2.ts"
...
diff -u apps/sync/lib/chalk_sync/contract/generated_v2.ex "$tmpdir/generated_v2.ex"
