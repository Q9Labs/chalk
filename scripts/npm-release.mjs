...
export const releasePackages = Object.freeze([
  ...
  { directory: "packages/whiteboard", name: "@q9labsai/chalk-whiteboard", version: "4.0.0" },
  { directory: "sdks/typescript/client", name: "@q9labsai/chalk-client", version: "4.0.0" },
  { directory: "sdks/typescript/react", name: "@q9labsai/chalk-react", version: "4.0.0" },
  { directory: "sdks/typescript/react-native", name: "@q9labsai/chalk-react-native", version: "4.0.0" },
]);
