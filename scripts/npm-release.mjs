...
export const releasePackages = Object.freeze([
  ...
  { directory: "packages/assets", name: "@q9labsai/chalk-assets", version: "4.1.10" },
  { directory: "packages/facehash", name: "@q9labsai/facehash", version: "4.1.10" },
  { directory: "packages/ui", name: "@q9labsai/chalk-ui", version: "4.1.10" },
  { directory: "packages/whiteboard", name: "@q9labsai/chalk-whiteboard", version: "4.1.10" },
  { directory: "sdks/typescript/client", name: "@q9labsai/chalk-client", version: "4.1.10" },
  { directory: "sdks/typescript/react", name: "@q9labsai/chalk-react", version: "4.1.10" },
  { directory: "sdks/typescript/react-native", name: "@q9labsai/chalk-react-native", version: "4.1.10" },
]);
