...
require 'state[[:space:]]+= var\.scheduler_state' "$MODULE_DIR/main.tf"
require 'variable "scheduler_state"' "$MODULE_DIR/variables.tf"
...
require 'control_api_invoke_policy_json' "$MODULE_DIR/outputs.tf"
