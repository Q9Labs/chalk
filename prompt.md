...
For any UI/frontend changes, verify visually using agent-browser. (for IOS tasks use ios-simulator skill):
...
When ALL stories have `passes: true`, output exactly on its own line: **_RALPH_ALL_STORIES_COMPLETE_**
