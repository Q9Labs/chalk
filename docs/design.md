...
This document describes Chalk's visual language across marketing, web, Spaces, SDK surfaces, and mobile. It defines a composable appearance system built around calm surfaces, precise structure, direct controls, and the four colors in the Chalk mark.
