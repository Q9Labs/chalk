	...
	return (
      ...
      <div className="relative z-10 flex flex-col items-center max-w-md w-full text-center">
        ...
        <div className="relative flex items-center justify-center mb-12">
          ...
          {/* Core Logo Container */}
          <div className={cn(
            "relative w-24 h-24 rounded-3xl flex items-center justify-center backdrop-blur-xl border shadow-2xl transition-all duration-700",
            error 
              ? "bg-destructive/10 border-destructive/30 shadow-destructive/20" 
              : "bg-background/80 border-primary/30 shadow-primary/20 animate-pulse"
          )}>
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-both">
          <h1 className="text-2xl font-black tracking-tight text-foreground">
            {error ? "Authentication Failed" : "Verifying Session"}
          </h1>
          
          <p className="text-base font-medium text-muted-foreground/80 max-w-[280px] mx-auto leading-relaxed">
            {error 
              ? "We couldn't verify your magic link. It may have expired." 
              : "Establishing a secure connection to your workspace..."}
          </p>
          ...
          {error && (
            <div className="pt-6 space-y-4">
              ...
              <button 
                ...
                className="w-full h-12 rounded-full bg-background border border-border hover:bg-muted font-bold text-sm transition-colors"
              >
                Return to Sign In
              </button>
            </div>
