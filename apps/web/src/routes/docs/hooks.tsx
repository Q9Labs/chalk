  ...
  return (
    <DocsLayout>
      <div className="space-y-6">
        <h1 className="text-4xl font-bold text-foreground">Hooks Reference</h1>
        <p className="text-lg text-muted-foreground">Complete reference for all React hooks provided by @q9labs/chalk-react.</p>
