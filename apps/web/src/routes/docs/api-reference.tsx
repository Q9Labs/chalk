			...
			<div className="space-y-8">
				<div>
					...
					<p className="mt-4 text-lg text-muted-foreground">
						Complete REST API documentation for the Chalk backend.
					</p>
				</div>
				...
				<div className="p-6 rounded-lg border border-border bg-card">
					...
					<code className="px-3 py-2 rounded bg-muted text-sm font-mono">
						https://chalk-api.q9labs.ai/api/v1
					</code>
				</div>
				...
				<div className="p-6 rounded-lg border border-border bg-muted/30">
					...
					<p className="text-muted-foreground mb-4">
						For complete request/response schemas, authentication details, and
						error codes, download the full OpenAPI specification.
					</p>
					<a
						href="/openapi.yaml"
						download="chalk-openapi.yaml"
		...
		<div>
			...
			<div className="space-y-2">
				{endpoints.map((endpoint) => (
					...
					>
						<span
							className={`px-2 py-1 rounded text-xs font-mono font-semibold ${methodColors[endpoint.method]}`}
						>
							{endpoint.method}
						</span>
