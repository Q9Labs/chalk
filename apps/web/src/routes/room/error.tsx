			...
			<div className="flex max-w-md flex-col items-center text-center p-8">
				...
				<div className="flex flex-col gap-3 w-full sm:flex-row sm:w-auto">
					<button
						type="button"
						onClick={handleRetry}
						className="flex-1 px-4 py-2 rounded-lg bg-[#8ab4f8] text-[#202124] font-medium hover:bg-[#a8c7fa] transition-colors focus:outline-none focus:ring-2 focus:ring-[#8ab4f8]/50"
					>
						Retry
					</button>
					<button
						...
						className="flex-1 px-4 py-2 rounded-lg bg-[#202124] text-white font-medium hover:bg-[#303134] transition-colors focus:outline-none focus:ring-2 focus:ring-[#202124]/50 border border-[#303134]"
					>
						Back to Lobby
					</button>
				</div>
