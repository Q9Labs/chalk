      ...
      try {
        ...
        try {
          ...
          if (room.status === "scheduled" && room.scheduledStartAt) {
            ...
            const joinOpenMs = scheduledStartMs - Math.max(0, room.allowEarlyJoinMinutes ?? 0) * 60_000;
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-3">
          ...
          <p className="text-sm text-muted-foreground">You can join when the meeting window opens.</p>
