...
import { Video, Zap, Code2, Globe2, Github, ArrowRight, CheckCircle2 } from "lucide-react";
          ...
          <div className="container mx-auto px-4 sm:px-8 text-center">
            <div className="mx-auto max-w-3xl space-y-8">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Add ultra low-latency video and audio to your application in minutes. 
                Built on Cloudflare's massive global network for uncompromised performance.
              </p>
              ...
              <div className="pt-8 flex items-center justify-center gap-8 text-muted-foreground/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-muted-foreground">99.99% Uptime</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500" />
                  <span className="text-sm font-medium text-muted-foreground">&lt; 100ms Latency</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500" />
                  <span className="text-sm font-medium text-muted-foreground">Global Edge</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <Card className="bg-background/60 backdrop-blur-sm border-muted/50">
                <CardHeader>
                  ...
                  <CardDescription className="text-base mt-2">
                    Powered by WebRTC and Cloudflare's edge network, ensuring your calls are crisp and real-time, no matter where your users are.
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="bg-background/60 backdrop-blur-sm border-muted/50">
                <CardHeader>
                  ...
                  <CardDescription className="text-base mt-2">
                    ...
                    Drop in our pre-built components or build your own UI from scratch.
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="bg-background/60 backdrop-blur-sm border-muted/50">
                <CardHeader>
                  ...
                  <CardDescription className="text-base mt-2">
                    ...
                    Scale from 1-on-1 calls to massive town halls without breaking a sweat.
                  </CardDescription>
                </CardHeader>
              </Card>
            </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground">
                  Get started with just a few lines of code. Our React hooks make state management a breeze.
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <p className="font-medium">Wrap your app in ChalkProvider</p>
                  </div>
                  <div className="flex items-center gap-4">
