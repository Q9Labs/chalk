...
import { formatPwaBuildLabel, getPwaPromptContent, getThemeColor, shouldHidePwaPrompt } from "./pwa";

describe("pwa helpers", () => {
  it("leaves browser chrome unthemed", () => {
    expect(getThemeColor("dark")).toBe("");
    expect(getThemeColor("light")).toBe("");
    expect(getThemeColor("unknown")).toBe("");
  });
