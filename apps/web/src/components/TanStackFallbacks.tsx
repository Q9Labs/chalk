import { FileQuestionIcon, HomeIcon, ArrowLeftIcon, AlertCircleIcon, RefreshCcw } from "lucide-react";
...
export const PendingComponent = memo(() => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] w-full p-8 animate-in fade-in duration-500">
      <ChalkLoader size={80} />
    </div>
  );
});
