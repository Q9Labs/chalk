      ...
      <svg width="600" height="400" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="overflow-visible">
        ...
        <g>
          ...
          <circle r="3" fill="#1bb6a6">
            <animateMotion dur="3s" repeatCount="indefinite" path="M100 100 L300 200" />
            <animate attributeName="opacity" values="0;1;0" dur="3s" repeatCount="indefinite" />
          </circle>

          {/* Top Right -> Center */}
          <circle r="3" fill="#1bb6a6">
            <animateMotion dur="2.5s" begin="0.5s" repeatCount="indefinite" path="M500 100 L300 200" />
            <animate attributeName="opacity" values="0;1;0" dur="2.5s" repeatCount="indefinite" />
          </circle>

          {/* Bottom Left -> Center */}
          <circle r="3" fill="#1bb6a6">
            <animateMotion dur="4s" begin="1s" repeatCount="indefinite" path="M100 300 L300 200" />
            <animate attributeName="opacity" values="0;1;0" dur="4s" repeatCount="indefinite" />
          </circle>

          {/* Bottom Right -> Center */}
          <circle r="3" fill="#1bb6a6">
            <animateMotion dur="3.5s" begin="1.5s" repeatCount="indefinite" path="M500 300 L300 200" />
