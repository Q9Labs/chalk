            ...
            {activeTab === "profile" && (
              <div className="space-y-10 animate-in fade-in slide-in-from-right-8 duration-700 ease-out">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-3 font-medium leading-relaxed max-w-md">
                    Customize your identity and meeting entry automated settings.
                  </p>
                </div>
                ...
                <div className="space-y-8">
                  <div className="space-y-3">
                    ...
                    <Input 
                      ...
                      className="h-14 bg-muted/20 border-border/40 focus:border-primary/50 focus:ring-primary/10 transition-all font-bold text-base px-5 rounded-2xl"
                    />
                    <p className="text-[11px] font-medium text-muted-foreground/70 ml-1">
                      This label will appear above your video feed in classrooms.
                    </p>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-3">
                      <button 
                        ...
                        className="flex items-center justify-between w-full p-5 rounded-3xl bg-muted/10 border border-border/30 hover:bg-muted/20 hover:border-primary/20 transition-all group cursor-pointer"
                      >
                        ...
                        <div className={cn(
                          "w-11 h-6 rounded-full p-1 transition-all duration-300 shadow-inner",
                          joinMuted ? "bg-primary" : "bg-muted-foreground/20"
                        )}>
                          <div className={cn(
                            "w-4 h-4 bg-white rounded-full transition-all duration-300 shadow-sm",
                            joinMuted ? "translate-x-5 scale-110" : "translate-x-0"
                          )} />
                        </div>
                      </button>

                      <button 
                        onClick={() => setJoinNoVideo(!joinNoVideo)}
                        className="flex items-center justify-between w-full p-5 rounded-3xl bg-muted/10 border border-border/30 hover:bg-muted/20 hover:border-primary/20 transition-all group cursor-pointer"
                      >
                        <div className="flex flex-col items-start gap-1">
                        ...
                        <div className={cn(
                          "w-11 h-6 rounded-full p-1 transition-all duration-300 shadow-inner",
                          joinNoVideo ? "bg-primary" : "bg-muted-foreground/20"
                        )}>
                          <div className={cn(
                            "w-4 h-4 bg-white rounded-full transition-all duration-300 shadow-sm",
                            joinNoVideo ? "translate-x-5 scale-110" : "translate-x-0"
                          )} />
                        </div>
                      </button>
                    </div>
            ...
            {activeTab === "appearance" && (
              <div className="space-y-10 animate-in fade-in slide-in-from-right-8 duration-700 ease-out">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-3 font-medium leading-relaxed max-w-md">
                    Choose an interface style that fits your workflow.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 rounded-full border-2 border-border/50 flex items-center justify-center bg-white">
                    ...
                    <button
                      ...
                      className={cn(
                        "relative p-5 rounded-[24px] border-2 text-left transition-all h-[140px] flex flex-col justify-between items-start group overflow-hidden active:scale-95",
                        theme === "nord" 
                          ? "border-[#88C0D0] bg-[#88C0D0]/10 shadow-2xl shadow-[#88C0D0]/10 ring-8 ring-[#88C0D0]/5" 
                          : "border-border/50 hover:border-[#88C0D0]/30 bg-[#2E3440]"
                      )}
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 rounded-full border-2 border-[#4C566A] flex items-center justify-center bg-[#3B4252]">
                          {theme === "nord" && <div className="w-3 h-3 rounded-full bg-[#88C0D0]" />}
                        </div>
                    ...
                    <button
                      ...
                      className={cn(
                        "relative p-5 rounded-[24px] border-2 text-left transition-all h-[140px] flex flex-col justify-between items-start group overflow-hidden active:scale-95",
                        theme === "dark" 
                          ? "border-primary bg-primary/10 shadow-2xl shadow-primary/20 ring-8 ring-primary/10" 
                          : "border-border/50 hover:border-primary/30 bg-[#09090b]"
                      )}
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 rounded-full border-2 border-zinc-800 flex items-center justify-center bg-zinc-900">
