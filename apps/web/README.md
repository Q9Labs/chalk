...
Implementation status lives in the root [human tracker](../../tracker-human.md), generated from [tracker.yaml](../../tracker.yaml). Route names and this integration guide are not release-readiness evidence.
