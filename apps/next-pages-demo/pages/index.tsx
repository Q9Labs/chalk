    ...
    <main className={`flex min-h-screen flex-col items-center justify-center p-24 ${inter.className}`}>
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400">Next.js Pages Router Integration Test</p>
        </div>
        ...
        <form onSubmit={handleJoinRoom} className="space-y-4">
          ...
          <button type="submit" disabled={!roomId.trim()} className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors">
            Join Room
          </button>
        </form>
        ...
        <div className="text-center text-sm text-gray-500">
          ...
          <button onClick={() => router.push("/room/demo-room-" + Date.now())} className="mt-2 text-blue-600 hover:underline">
            Create instant room
          </button>
        </div>
      </div>
