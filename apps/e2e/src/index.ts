...
import { assertApiRecordingState, assertWebhookDelivery, buildUpdatedWebhookConfig, decodeTenantConfigFromApi, extractPostMeetingWebhookConfig, type AssertionResult, type TenantPostMeetingWebhookConfig } from "./assertions";
...
async function main(): Promise<void> {
  ...
  try {
    ...
    console.log("Assertions enabled by tenant config:", {
      include_recording: existingWebhookCfg.include_recording || (existingWebhookCfg.include_transcript || existingWebhookCfg.include_summary || existingWebhookCfg.include_action_items ? false : true),
