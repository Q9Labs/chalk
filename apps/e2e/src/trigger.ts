...
export async function generateR2PresignedUrl(opts: {
	accountId: string;
	accessKeyId: string;
...
export async function triggerSimulatedCloudflareWebhook(opts: {
	apiBaseUrl: string;
	cfRecordingId: string;
	downloadUrl: string;
	downloadUrlExpiryIso: string;
	roomCloudflareMeetingId: string;
