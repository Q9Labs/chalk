defmodule ChalkSync.RoomActions.OutboundQueueTest do
  use ExUnit.Case, async: true

  alias ChalkSync.RoomActions.OutboundQueue

  test "preserves FIFO and yields to pending control after eight room actions" do
