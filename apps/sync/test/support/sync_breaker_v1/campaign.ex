defmodule ChalkSync.SyncBreakerV1.Campaign do
  @moduledoc false

  alias ChalkSync.SyncBreakerV1.DeliveryRecoveryPhase
  alias ChalkSync.SyncBreakerV1.DurableLifecyclePhase
  ...
  def run!(database_url, seed \\ 730_013) when is_binary(database_url) and is_integer(seed) do
    ...
    if postgres_major != 18 do
      raise "SyncEngine v1 breaker requires PostgreSQL 18, got #{postgres_major}"
    end
