...
export const PREVIEW_STAGES = ["people", "whiteboard"] as const;
export type PreviewStage = (typeof PREVIEW_STAGES)[number];

export const PREVIEW_DIALOGS = ["none", "more", "settings", "reactions"] as const;
...
type PreviewChrome = (typeof PREVIEW_CHROME)[number];
...
const SEARCH_KEYS = ["view", "state", "layout", "panel", "stage", "dialog", "palette", "texture", "chrome", "participants", "chat", "mic", "camera", "hand"] as const;
