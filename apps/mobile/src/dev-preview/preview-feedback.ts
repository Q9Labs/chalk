...
function previewReceipt(): FeedbackReportReceiptV1 {
  return {
...
function withDefaults(input: Partial<FeedbackEvidenceInput> | undefined, screenshot: FeedbackScreenshotCapture | FeedbackScreenshotUnavailable): FeedbackEvidenceInput {
  return {
    sdk: input?.sdk ?? { client: "@q9labsai/chalk-client", react_native: "@q9labsai/chalk-react-native" },
    platform: input?.platform ?? { kind: "ios" },
