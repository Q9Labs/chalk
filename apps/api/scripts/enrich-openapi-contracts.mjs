...
function enrichOperations(spec) {
  ...
  set(
    ...
    op({
      ...
      tags: ["Internal"],
      security: [{ BearerAuth: [] }],
      parameters: [queryParam("limit", "Maximum number of meetings", { type: "integer", default: 50, minimum: 1 }), queryParam("offset", "Number of meetings to skip", { type: "integer", default: 0, minimum: 0 })],
      responses: {
  ...
  set(
    ...
    op({
      ...
      tags: ["WebSocket"],
      security: [],
      parameters: [queryParam("token", "JWT token fallback for clients unable to set subprotocol token", { type: "string" }), queryParam("room", "Optional room identifier for diagnostics", { type: "string" })],
      responses: {
