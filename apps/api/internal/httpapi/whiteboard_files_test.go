...
func whiteboardTestSubject(t *testing.T) whiteboardfiles.Subject {
	...
	return whiteboardfiles.Subject{
		...
		SpaceID:               whiteboardTestID(t, "22222222-2222-4222-8222-222222222222"),
		EpisodeID:             whiteboardTestID(t, "33333333-3333-4333-8333-333333333333"),
		ParticipantID:         whiteboardTestID(t, "44444444-4444-4444-8444-444444444444"),
