...
globalThis.CHALK_API_DESIGN_OPENAPI = {
  ...
  paths: {
      ...
      get: {
        ...
        responses: {
          ...
          400: {
            ...
            description: "Bad Request",
            "x-chalk-error-codes": ["episode.invalid_id", "pagination.invalid_cursor", "pagination.invalid_page_size", "space.invalid_id", "tenant.invalid_id"],
          },
          401: {
            content: {
              "application/json": {
    ...
    "/v1/tenants/{tenant_id}/recordings/{recording_id}/export": {
      post: {
        operationId: "requestRecordingExport",
        parameters: [
          {
            in: "path",
            name: "tenant_id",
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: {
                $ref: "#/components/schemas/RequestRecordingExportRequest",
              },
            },
          },
          required: true,
        ...
        responses: {
          202: {
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/RecordingExportRequestAcceptedResponse",
                },
              },
            },
            description: "Accepted",
          ...
          400: {
            ...
            description: "Bad Request",
            "x-chalk-error-codes": ["recording.invalid_id", "recording.not_ready", "tenant.invalid_id"],
          },
          401: {
            content: {
              "application/json": {
        ...
        summary: "Request recording export",
        "x-chalk-max-body-bytes": 1048576,
        "x-chalk-rate-limit": {
          limit: 60,
          name: "v1.authenticated.write",
      ...
      post: {
        ...
        responses: {
          ...
          409: {
            ...
            description: "Conflict",
            "x-chalk-error-codes": ["transcript.already_exists", "transcript.disabled", "transcript.source_expired"],
          },
          413: {
            content: {
              "application/json": {
    ...
    "/v1/tenants/{tenant_id}/spaces/{space_id}/recording-preparation": {
      get: {
        operationId: "getSpaceRecordingPreparation",
        parameters: [
          {
            in: "path",
            name: "tenant_id",
        ...
        responses: {
          200: {
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/RecordingPreparation",
                },
              },
            },
            description: "OK",
          ...
          400: {
            ...
            description: "Bad Request",
            "x-chalk-error-codes": ["recording_preparation.invalid", "space.invalid_id", "tenant.invalid_id"],
          },
          401: {
            content: {
              "application/json": {
          ...
          404: {
            ...
            description: "Not Found",
            "x-chalk-error-codes": ["recording_preparation.not_found"],
          },
          500: {
            content: {
              "application/json": {
        ...
        summary: "Get space recording preparation",
      },
      patch: {
        operationId: "prepareSpaceRecording",
        parameters: [
          {
            in: "path",
            name: "tenant_id",
        ...
        responses: {
          ...
          403: {
            ...
            description: "Forbidden",
            "x-chalk-error-codes": ["access.forbidden", "recording_preparation.policy_denied"],
          },
          404: {
            content: {
              "application/json": {
          ...
          409: {
            ...
            description: "Conflict",
            "x-chalk-error-codes": ["recording_preparation.conflict"],
          },
          413: {
            content: {
              "application/json": {
        ...
        summary: "Prepare space recording",
        "x-chalk-max-body-bytes": 1048576,
        "x-chalk-rate-limit": {
          limit: 60,
          name: "v1.authenticated.write",
    ...
    "/v1/tenants/{tenant_id}/spaces/{space_id}/recording-preparation/cancel": {
      post: {
        operationId: "cancelSpaceRecordingPreparation",
        parameters: [
          {
            in: "path",
            name: "tenant_id",
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: {
                $ref: "#/components/schemas/CancelRecordingPreparationRequest",
              },
            },
          },
          required: true,
        ...
        summary: "Cancel space recording preparation",
        "x-chalk-max-body-bytes": 1048576,
        "x-chalk-rate-limit": {
          limit: 60,
          name: "v1.authenticated.write",
    ...
    "/v1/tenants/{tenant_id}/transcripts/{transcript_id}/document": {
      get: {
        operationId: "getTranscriptDocument",
        parameters: [
          {
            in: "path",
            name: "tenant_id",
        ...
        responses: {
          200: {
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/TranscriptDocument",
                },
              },
            },
            description: "OK",
          ...
          404: {
            ...
            description: "Not Found",
            "x-chalk-error-codes": ["recording_artifact.not_found", "transcript.not_found"],
          },
          409: {
            content: {
              "application/json": {
        ...
        summary: "Get transcript document",
      },
    },
  ...
  components: {
    ...
    schemas: {
      ...
      CancelRecordingPreparationRequest: {
        additionalProperties: false,
        properties: {
          expected_revision: {
            type: "integer",
      ...
      PrepareRecordingRequest: {
        ...
        required: ["expected_revision", "starts_at"],
        type: "object",
      },
      ...
      Recording: {
        ...
        properties: {
          ...
          export: {
            $ref: "#/components/schemas/RecordingExport",
          },
          id: {
            $ref: "#/components/schemas/RecordingId",
          },
      ...
      RecordingExport: {
        ...
        properties: {
          ...
          status: {
            enum: ["none", "pending", "ready", "failed", "unavailable"],
            type: "string",
          },
        },
      ...
      RecordingPreparation: {
        ...
        required: ["capacity_available", "expires_at", "prepares_at", "ready", "revision", "space_id", "starts_at", "state", "updated_at"],
        type: "object",
      },
      RecordingSource: {
        additionalProperties: false,
      ...
      TranscriptDocument: {
            ...
            items: {
              ...
              properties: {
                ...
                identity: {
                  ...
                  required: ["participant_generation", "participant_ref", "track_epoch", "track_id"],
                  type: ["object", "null"],
                },
                overlap: {
                  type: "boolean",
              ...
              required: ["end_ms", "overlap", "start_ms", "text"],
              type: "object",
            },
            type: "array",
          },
        ...
        required: ["cues", "episode_id", "recording_id", "schema_version", "transcript_id"],
        type: "object",
      },
