...
const typeScriptEmitter = resolve(repositoryRoot, "tools/contract-fixture-proof/src/emitters/whiteboard-typescript.mjs");
const elixirEmitter = resolve(repositoryRoot, "tools/contract-fixture-proof/src/emitters/whiteboard-elixir.mjs");
