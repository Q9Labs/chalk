...
describe("ContractIR frontends", () => {
  ...
  it("rejects unknown declaration kinds, duplicates, dangling refs, impossible constraints, and malformed operation or sync shapes", async () => {
    ...
    const space = required(/** @type {ContractObject[]} */ (impossibleConstraints.declarations).find((declaration) => declaration.id === "chalk.Space"));
    const title = required(/** @type {ContractObject[]} */ (space.fields).find((field) => field.name === "title"));
