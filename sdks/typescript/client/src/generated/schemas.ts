...
export const AIProviderConfigSchema = Schema.StructWithRest(Schema.Struct({
...
export const MediaPlaneProviderConfigSchema = Schema.StructWithRest(Schema.Struct({
  "cloudflare": Schema.optional(Schema.StructWithRest(Schema.Struct({
  "account_id": Schema.optional(Schema.String.check(Schema.isMinLength(1))),
  "api_token": Schema.optional(Schema.String.check(Schema.isMinLength(1))),
  "rtk": Schema.optional(Schema.StructWithRest(Schema.Struct({
  "app_id": Schema.optional(Schema.String.check(Schema.isMinLength(1))),
  "enabled": Schema.optional(Schema.Boolean),
  "host_preset": Schema.optional(Schema.String.check(Schema.isMinLength(1))),
  "participant_preset": Schema.optional(Schema.String.check(Schema.isMinLength(1)))
}), [Schema.Record(Schema.String, Schema.Unknown)])),
  "sfu": Schema.optional(Schema.StructWithRest(Schema.Struct({
  "app_id": Schema.optional(Schema.String.check(Schema.isMinLength(1))),
  "app_secret": Schema.optional(Schema.String.check(Schema.isMinLength(1))),
  "enabled": Schema.optional(Schema.Boolean)
}), [Schema.Record(Schema.String, Schema.Unknown)]))
}), [Schema.Record(Schema.String, Schema.Unknown)])),
  "enabled": Schema.optional(Schema.Boolean),
  "mode": Schema.optional(Schema.Literals(["chalk_managed", "tenant_managed"])),
  "provider": Schema.optional(Schema.Literals(["cf_sfu", "cf_rtk"]))
}), [Schema.Record(Schema.String, Schema.Unknown)])
export type MediaPlaneProviderConfig = typeof MediaPlaneProviderConfigSchema.Type

export const StorageProviderConfigSchema = Schema.StructWithRest(Schema.Struct({
...
export const IntegrationServicesSchema = Schema.Struct({
  "families": Schema.Array(Schema.Struct({
  "name": Schema.String,
...
export const AdmitSessionParticipantErrorSchema = Schema.Union([ForbiddenErrorSchema, IdempotencyConflictErrorSchema, InternalErrorSchema, InvalidIdempotencyKeyErrorSchema, InvalidParticipantSessionIdErrorSchema, InvalidRequestErrorSchema, InvalidRoomIdErrorSchema, InvalidSessionIdErrorSchema, InvalidTenantIdErrorSchema, LifecycleCapacityExceededErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, SessionNotActiveErrorSchema, UnauthenticatedErrorSchema])
...
export const CreateMembershipErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidMembershipRoleErrorSchema, InvalidRequestErrorSchema, InvalidTenantIdErrorSchema, InvalidUserIdErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type CreateMembershipError = typeof CreateMembershipErrorSchema.Type

export const CreateRecordingDownloadURLErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRecordingIdErrorSchema, InvalidRequestErrorSchema, InvalidStorageKeyErrorSchema, InvalidStorageProviderErrorSchema, InvalidTenantIdErrorSchema, InvalidUrlExpirationErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, RecordingNotReadyErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type CreateRecordingDownloadURLError = typeof CreateRecordingDownloadURLErrorSchema.Type

export const CreateRecordingErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRecordingFieldErrorSchema, InvalidRecordingStatusErrorSchema, InvalidRequestErrorSchema, InvalidRoomIdErrorSchema, InvalidSessionIdErrorSchema, InvalidStorageKeyErrorSchema, InvalidStorageProviderErrorSchema, InvalidTenantIdErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
...
export const CreateRoomSessionErrorSchema = Schema.Union([ForbiddenErrorSchema, IdempotencyConflictErrorSchema, InternalErrorSchema, InvalidIdempotencyKeyErrorSchema, InvalidRequestErrorSchema, InvalidRoomFieldErrorSchema, InvalidRoomIdErrorSchema, InvalidTenantIdErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type CreateRoomSessionError = typeof CreateRoomSessionErrorSchema.Type

export const CreateTenantErrorSchema = Schema.Union([InternalErrorSchema, InvalidRequestErrorSchema, InvalidTenantFieldErrorSchema, InvalidTenantNameErrorSchema, InvalidTenantRegionErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type CreateTenantError = typeof CreateTenantErrorSchema.Type

export const CreateTranscriptErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRecordingIdErrorSchema, InvalidRequestErrorSchema, InvalidRoomIdErrorSchema, InvalidSessionIdErrorSchema, InvalidTenantIdErrorSchema, InvalidTranscriptFieldErrorSchema, InvalidTranscriptLanguagesErrorSchema, InvalidTranscriptModelErrorSchema, InvalidTranscriptProviderErrorSchema, InvalidTranscriptStatusErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
...
export const DisableIntegrationConnectionErrorSchema = Schema.Union([ForbiddenErrorSchema, IntegrationConnectionNotActiveErrorSchema, IntegrationConnectionNotFoundErrorSchema, IntegrationProviderRateLimitedErrorSchema, IntegrationProviderUnauthorizedErrorSchema, IntegrationProviderUnavailableErrorSchema, InternalErrorSchema, InvalidIntegrationConnectionIdErrorSchema, InvalidTenantIdErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type DisableIntegrationConnectionError = typeof DisableIntegrationConnectionErrorSchema.Type

export const EndRoomSessionErrorSchema = Schema.Union([ForbiddenErrorSchema, IdempotencyConflictErrorSchema, InternalErrorSchema, InvalidIdempotencyKeyErrorSchema, InvalidRoomIdErrorSchema, InvalidSessionIdErrorSchema, InvalidTenantIdErrorSchema, LifecycleCapacityExceededErrorSchema, NotFoundErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, SessionNotActiveErrorSchema, UnauthenticatedErrorSchema])
export type EndRoomSessionError = typeof EndRoomSessionErrorSchema.Type

export const ExecuteIntegrationActionErrorSchema = Schema.Union([ForbiddenErrorSchema, IntegrationActionNotAllowedErrorSchema, IntegrationConnectionNotActiveErrorSchema, IntegrationConnectionNotFoundErrorSchema, IntegrationProviderRateLimitedErrorSchema, IntegrationProviderUnauthorizedErrorSchema, IntegrationProviderUnavailableErrorSchema, InternalErrorSchema, InvalidIntegrationActionErrorSchema, InvalidIntegrationActionInputErrorSchema, InvalidIntegrationActionTextErrorSchema, InvalidIntegrationConnectionIdErrorSchema, InvalidRequestErrorSchema, InvalidTenantIdErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
...
export const ListIntegrationConnectionsErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidCursorErrorSchema, InvalidIntegrationProviderErrorSchema, InvalidIntegrationServiceErrorSchema, InvalidPageSizeErrorSchema, InvalidTenantIdErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
...
export const RefreshIntegrationConnectionErrorSchema = Schema.Union([ForbiddenErrorSchema, IntegrationConnectionNotActiveErrorSchema, IntegrationConnectionNotFoundErrorSchema, IntegrationProviderRateLimitedErrorSchema, IntegrationProviderUnauthorizedErrorSchema, IntegrationProviderUnavailableErrorSchema, InternalErrorSchema, InvalidIntegrationConnectionIdErrorSchema, InvalidTenantIdErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type RefreshIntegrationConnectionError = typeof RefreshIntegrationConnectionErrorSchema.Type

export const RegisterErrorSchema = Schema.Union([EmailAlreadyRegisteredErrorSchema, EmailVerificationRequiredErrorSchema, InternalErrorSchema, InvalidEmailErrorSchema, InvalidPasswordErrorSchema, InvalidRequestErrorSchema, InvalidUserNameErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema])
export type RegisterError = typeof RegisterErrorSchema.Type

export const RemoveSessionParticipantErrorSchema = Schema.Union([ForbiddenErrorSchema, IdempotencyConflictErrorSchema, InternalErrorSchema, InvalidIdempotencyKeyErrorSchema, InvalidParticipantSessionIdErrorSchema, InvalidRequestErrorSchema, InvalidRoomIdErrorSchema, InvalidSessionIdErrorSchema, InvalidTenantIdErrorSchema, LifecycleCapacityExceededErrorSchema, NotFoundErrorSchema, ParticipantGenerationMismatchErrorSchema, ParticipantNotActiveErrorSchema, ParticipantNotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, SessionNotActiveErrorSchema, UnauthenticatedErrorSchema])
...
export const StartIntegrationConnectionErrorSchema = Schema.Union([ForbiddenErrorSchema, IntegrationConnectionAlreadyExistsErrorSchema, IntegrationProviderUnavailableErrorSchema, InternalErrorSchema, InvalidCallbackUrlErrorSchema, InvalidIntegrationProviderErrorSchema, InvalidIntegrationServiceErrorSchema, InvalidRequestErrorSchema, InvalidTenantIdErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type StartIntegrationConnectionError = typeof StartIntegrationConnectionErrorSchema.Type

export const TranscribeRecordingErrorSchema = Schema.Union([AiProviderFailedErrorSchema, AiProviderPaymentRequiredErrorSchema, AiProviderRateLimitedErrorSchema, AiProviderUnauthorizedErrorSchema, ForbiddenErrorSchema, InternalErrorSchema, InvalidAiAudioErrorSchema, InvalidAiConfigErrorSchema, InvalidAiGatewayErrorSchema, InvalidAiModelErrorSchema, InvalidRecordingIdErrorSchema, InvalidRequestErrorSchema, InvalidStorageKeyErrorSchema, InvalidStorageProviderErrorSchema, InvalidTenantIdErrorSchema, MissingAiCredentialsErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, RecordingNotReadyErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type TranscribeRecordingError = typeof TranscribeRecordingErrorSchema.Type

export const UpdateMembershipErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidMembershipIdErrorSchema, InvalidMembershipRoleErrorSchema, InvalidRequestErrorSchema, InvalidTenantIdErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type UpdateMembershipError = typeof UpdateMembershipErrorSchema.Type

export const UpdateRecordingErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRecordingFieldErrorSchema, InvalidRecordingIdErrorSchema, InvalidRecordingStatusErrorSchema, InvalidRequestErrorSchema, InvalidStorageKeyErrorSchema, InvalidStorageProviderErrorSchema, InvalidTenantIdErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type UpdateRecordingError = typeof UpdateRecordingErrorSchema.Type

export const UpdateRoomErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRequestErrorSchema, InvalidRoomIdErrorSchema, InvalidTenantIdErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, RoomSlugAlreadyUsedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type UpdateRoomError = typeof UpdateRoomErrorSchema.Type

export const UpdateRoomSessionErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRequestErrorSchema, InvalidRoomFieldErrorSchema, InvalidRoomIdErrorSchema, InvalidSessionIdErrorSchema, InvalidSessionStatusErrorSchema, InvalidTenantIdErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type UpdateRoomSessionError = typeof UpdateRoomSessionErrorSchema.Type

export const UpdateTenantErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRequestErrorSchema, InvalidTenantFieldErrorSchema, InvalidTenantIdErrorSchema, InvalidTenantNameErrorSchema, InvalidTenantRegionErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
export type UpdateTenantError = typeof UpdateTenantErrorSchema.Type

export const UpdateTranscriptErrorSchema = Schema.Union([ForbiddenErrorSchema, InternalErrorSchema, InvalidRequestErrorSchema, InvalidTenantIdErrorSchema, InvalidTranscriptFieldErrorSchema, InvalidTranscriptIdErrorSchema, InvalidTranscriptLanguagesErrorSchema, InvalidTranscriptModelErrorSchema, InvalidTranscriptProviderErrorSchema, InvalidTranscriptStatusErrorSchema, NotFoundErrorSchema, PayloadTooLargeErrorSchema, RateLimitedErrorSchema, ServiceUnavailableErrorSchema, UnauthenticatedErrorSchema])
