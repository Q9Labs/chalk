// Generated by tools/contract-codegen/src/emitters/whiteboard-typescript.mjs
// Do not edit by hand.
...
export const WhiteboardV1ProtocolMetadata = {
  ...
  frames: {
    ...
    cursor: {
      ...
      serverExactFields: ["type", "participant_session_id", "display_name", "x", "y", "occurred_at"],
    },
    welcome: {
      exactFields: ["type", "protocol", "participant_session_id", "participant_session_generation", "capabilities", "participant_capabilities", "scene_id", "revision", "can_draw"],
    },
    snapshotPage: {
    ...
    permissionUpdated: {
      exactFields: ["type", "participant_session_id", "can_draw"],
    },
    resetRequired: {
...
export type WhiteboardV1ServerFrame =
  ...
  | {
      ...
      readonly operation: "submit_update" | "request_snapshot" | "clear" | "set_draw_permission";
...
function isClientFrame(value: unknown): value is WhiteboardV1ClientFrame {
  ...
  switch (value.type) {
    case "hello":
      return (
        hasExactKeys(value, WhiteboardV1ProtocolMetadata.frames.hello.exactFields) &&
    ...
    case "set_draw_permission":
      return (
        ...
        isBoundedIdentifier(value.operation_id, WhiteboardV1ProtocolLimits.operationIdMinBytes, WhiteboardV1ProtocolLimits.operationIdMaxBytes) &&
        isUuid(value.participant_session_id) &&
...
function isServerFrame(value: unknown): value is WhiteboardV1ServerFrame {
  ...
  switch (value.type) {
    case "welcome":
      return (
        hasExactKeys(value, WhiteboardV1ProtocolMetadata.frames.welcome.exactFields) &&
        value.protocol === "whiteboard-v1" &&
        isUuid(value.participant_session_id) &&
        Number.isSafeInteger(value.participant_session_generation) &&
        Number(value.participant_session_generation) > 0 &&
    ...
    case "operation_error":
      return (
        ...
        ["submit_update", "request_snapshot", "clear", "set_draw_permission"].includes(String(value.operation)) &&
