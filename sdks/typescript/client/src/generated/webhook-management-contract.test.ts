...
import {
  WebhookIdempotencyKeyRequiredErrorWireSchema,
  WebhookIdempotencyConflictErrorWireSchema,
  WebhookIdempotencyExpiredErrorWireSchema,
  WebhookInvalidApiVersionErrorWireSchema,
  WebhookInvalidDeliveryIdErrorWireSchema,
  WebhookInvalidEndpointIdErrorWireSchema,
  WebhookInvalidEventTypeErrorWireSchema,
  WebhookInvalidUrlErrorWireSchema,
  WebhookUnsafeUrlErrorWireSchema,
...
describe("generated webhook management contract", () => {
  ...
  it("keeps Attempt detail and stable webhook error codes decodable", () => {
    ...
    const stableErrors = [
      [WebhookIdempotencyConflictErrorWireSchema, "webhook.idempotency_conflict"],
      [WebhookIdempotencyExpiredErrorWireSchema, "webhook.idempotency_expired"],
      [WebhookIdempotencyKeyRequiredErrorWireSchema, "webhook.idempotency_key_required"],
      [WebhookInvalidApiVersionErrorWireSchema, "webhook.invalid_api_version"],
      [WebhookInvalidDeliveryIdErrorWireSchema, "webhook.invalid_delivery_id"],
      [WebhookInvalidEndpointIdErrorWireSchema, "webhook.invalid_endpoint_id"],
      [WebhookInvalidEventTypeErrorWireSchema, "webhook.invalid_event_type"],
      [WebhookInvalidUrlErrorWireSchema, "webhook.invalid_url"],
      [WebhookUnsafeUrlErrorWireSchema, "webhook.unsafe_url"],
      [WebhookDeliveryNotFoundErrorWireSchema, "webhook.delivery_not_found"],
      [WebhookDeliveryNotRedeliverableErrorWireSchema, "webhook.delivery_not_redeliverable"],
      [WebhookEndpointLimitReachedErrorWireSchema, "webhook.endpoint_limit_reached"],
      [WebhookEndpointNotFoundErrorWireSchema, "webhook.endpoint_not_found"],
      [WebhookEndpointRevisionConflictErrorWireSchema, "webhook.endpoint_revision_conflict"],
      [WebhookEventErasedErrorWireSchema, "webhook.event_erased"],
      [WebhookEventTypeUnavailableErrorWireSchema, "webhook.event_type_unavailable"],
    ] as const;
