...
const CONNECTION_ERROR_CODE_MAP = {
  ...
  device_not_found: "media.device_not_found",
  device_busy: "media.device_busy",
  device_constraint_invalid: "media.device_constraint_invalid",
  media_capture_failed: "media.capture_failed",
