...
export interface NativeChatMessageListProps {
...
export function NativeChatMessageList({ messages, localParticipantId, onLatestMessageVisible, style, contentContainerStyle }: NativeChatMessageListProps): React.JSX.Element {
