...
export function PreJoinLobbyMacos({ roomName, error, joinDisabled = false, onCancel, ...props }: PreJoinLobbyProps): React.JSX.Element {
...
export { PreJoinLobbyMacos as PreJoinLobby };
