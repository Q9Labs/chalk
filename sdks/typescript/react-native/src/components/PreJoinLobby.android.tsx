...
import { usePreJoinLobbyController } from "./native-prejoin/usePreJoinLobbyController";
import { useMemo } from "react";

export function PreJoinLobbyAndroid({ roomName, error, joinDisabled = false, onCancel, ...props }: PreJoinLobbyProps): React.JSX.Element {
  const controller = usePreJoinLobbyController({ ...props, joinDisabled });
...
export { PreJoinLobbyAndroid as PreJoinLobby };
