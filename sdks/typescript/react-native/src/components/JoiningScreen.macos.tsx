...
export function JoiningScreenMacos({ displayName, message = "Preparing meeting...", supportingMessages }: JoiningScreenProps): React.JSX.Element {
...
export { JoiningScreenMacos as JoiningScreen };
