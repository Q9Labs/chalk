...
import type { JoiningLoadingScreenProps } from "./JoiningLoadingScreen";
...
export function JoiningLoadingScreenAndroid({ message = "Preparing meeting..." }: JoiningLoadingScreenProps): React.JSX.Element {
...
export { JoiningLoadingScreenAndroid as JoiningLoadingScreen };
