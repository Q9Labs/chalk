...
export function PreJoinScreenMacos({ roomName, error, joinDisabled = false, onCancel, ...props }: PreJoinScreenProps): React.JSX.Element {
...
export { PreJoinScreenMacos as PreJoinScreen };
