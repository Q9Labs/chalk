...
export function PreJoinScreenAndroid({ roomName, error, joinDisabled = false, onCancel, ...props }: PreJoinScreenProps): React.JSX.Element {
...
export { PreJoinScreenAndroid as PreJoinScreen };
