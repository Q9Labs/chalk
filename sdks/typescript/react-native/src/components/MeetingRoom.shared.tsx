...
import { useMeetingRoomController } from "./native-meeting-room/useMeetingRoomController";

export function MeetingRoomShared(props: MeetingRoomProps): React.JSX.Element {
  const controller = useMeetingRoomController(props);
