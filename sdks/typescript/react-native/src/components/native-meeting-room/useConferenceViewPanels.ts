...
export function useConferenceViewPanels({ roomName, meetingLink, canWhiteboard, isHost, session, room, telemetry, onLeave, onEndForAll, run }: UseConferenceViewPanelsOptions): ConferenceViewPanels {
