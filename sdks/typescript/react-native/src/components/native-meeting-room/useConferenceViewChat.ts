...
export interface ConferenceViewChat {
...
interface UseConferenceViewChatOptions {
  readonly session: Pick<ChalkSessionStore, "chatFiles">;
  readonly chat: Pick<UseChatReturn, "sendMessage" | "markAsRead">;
  readonly pickChatAttachments: ConferenceViewProps["pickChatAttachments"];
  readonly run: ConferenceViewActionRunner;
}

export function useConferenceViewChat({ session, chat, pickChatAttachments, run }: UseConferenceViewChatOptions): ConferenceViewChat {
