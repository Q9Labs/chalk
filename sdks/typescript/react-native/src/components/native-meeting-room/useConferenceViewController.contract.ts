...
import type { ConferenceViewChat } from "./useConferenceViewChat";
...
type ExpectedConferenceViewController = {
  ...
  readonly activeReactions: ConferenceViewInteractions["activeReactions"];
...
export type ConferenceViewControllerContractCheck = Assert<IsAssignableBothWays<ReturnType<typeof useConferenceViewController>, ExpectedConferenceViewController>>;
