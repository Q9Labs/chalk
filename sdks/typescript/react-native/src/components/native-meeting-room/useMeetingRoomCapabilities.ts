...
import type { MeetingRoomActionAvailability } from "./diagnostics";
import { resolveNativeScreenShareAvailability } from "./screen-share-availability";

export interface MeetingRoomCapabilities {
...
interface UseMeetingRoomCapabilitiesOptions {
  readonly features: MeetingRoomProps["features"];
...
export function useMeetingRoomCapabilities({ features, session, snapshot, chat, interactions }: UseMeetingRoomCapabilitiesOptions): MeetingRoomCapabilities {
