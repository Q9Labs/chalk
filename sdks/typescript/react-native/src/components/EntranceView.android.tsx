...
export function EntranceViewAndroid({ spaceName, error, joinDisabled = false, onCancel, ...props }: EntranceViewProps): React.JSX.Element {
...
export { EntranceViewAndroid as EntranceView };
