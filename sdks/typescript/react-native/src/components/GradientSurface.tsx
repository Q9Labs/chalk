...
function GradientSurfaceBase({ participantId, gradientPreference, borderRadius = 0, angle = "vertical", opacity = 1, variant = "surface" }: GradientSurfaceProps): React.JSX.Element {
