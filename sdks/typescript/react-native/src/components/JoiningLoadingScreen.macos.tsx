...
export function JoiningLoadingScreenMacos({ message = "Preparing meeting..." }: JoiningLoadingScreenProps): React.JSX.Element {
...
export { JoiningLoadingScreenMacos as JoiningLoadingScreen };
