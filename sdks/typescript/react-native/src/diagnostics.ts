...
const isVitestRuntime = runtimeEnv.VITEST === "true";
const isDevelopmentRuntime = typeof __DEV__ !== "undefined" ? __DEV__ : isVitestRuntime || runtimeEnv.NODE_ENV !== "production";
...
export type DevDiagnosticsDeviceInfo = NativeDeviceInfo;
