...
export type EntrancePreviewStore = ExternalStore<PreviewSnapshot>;

interface EntrancePreviewStoreOptions {
...
export function createEntrancePreviewStore(options: EntrancePreviewStoreOptions): EntrancePreviewStore {
