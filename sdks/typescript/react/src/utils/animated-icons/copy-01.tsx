...
export interface Copy01IconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}

const FRONT_PATH = "M9 15C9 12.1716 9 10.7574 9.87868 9.87868C10.7574 9 12.1716 9 15 9L16 9C18.8284 9 20.2426 9 21.1213 9.87868C22 10.7574 22 12.1716 22 15V16C22 18.8284 22 20.2426 21.1213 21.1213C20.2426 22 18.8284 22 16 22H15C12.1716 22 10.7574 22 9.87868 21.1213C9 20.2426 9 18.8284 9 16L9 15Z";

const COPY_DURATION = 0.86;
const COPY_TIMES = [0, 0.1, 0.34, 0.46, 0.56, 0.76, 0.88, 1];
const COPY_EASING: Easing[] = [[0.23, 1, 0.32, 1], [0.77, 0, 0.175, 1], [0.23, 1, 0.32, 1], "linear", [0.77, 0, 0.175, 1], [0.23, 1, 0.32, 1], [0.23, 1, 0.32, 1]];
...
const frontVariants: Variants = {
  ...
  animate: {
    ...
    strokeWidth: [1.5, 1.5 / 0.97, 1.5 / 1.2, 1.5 / 1.14, 1.5 / 1.14, 1.5 / 0.96, 1.5 / 1.03, 1.5],
    visibility: "visible",
    transition: {
...
const Copy01Icon = forwardRef<Copy01IconHandle, Copy01IconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
        ...
        <defs>
          <mask id={occlusionMaskId} maskUnits="userSpaceOnUse" x="-4" y="-4" width="32" height="32">
            ...
            <motion.g variants={generatedGeometryVariants} animate={controls} initial="normal">
              <motion.path d={FRONT_PATH} fill="black" stroke="black" strokeLinejoin="round" strokeWidth="2.5" variants={occlusionVariants} animate={controls} initial="normal" style={{ transformOrigin: "15.5px 15.5px" }} />
            </motion.g>
          </mask>
        </defs>
        <motion.path d={FRONT_PATH} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" variants={frontVariants} animate={controls} initial="normal" style={{ transformOrigin: "15.5px 15.5px" }} />
        <motion.path
