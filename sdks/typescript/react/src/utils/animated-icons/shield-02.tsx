...
export interface Shield02IconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const Shield02Icon = forwardRef<Shield02IconHandle, Shield02IconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
