...
export interface ThumbsUpIconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const ThumbsUpIcon = forwardRef<ThumbsUpIconHandle, ThumbsUpIconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
  ...
  return (
    <div className={cn("inline-flex", className)} style={{ strokeWidth: 1.5 }} data-hugeicons-animated="true">
      <svg onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props} className="h-full w-full" xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" overflow="visible">
        <motion.g variants={handVariants} animate={controls} initial="normal" style={{ transformOrigin: "7px 18px" }}>
          <path d="M2 12.5C2 11.3954 2.89543 10.5 4 10.5C5.65685 10.5 7 11.8431 7 13.5V17.5C7 19.1569 5.65685 20.5 4 20.5C2.89543 20.5 2 19.6046 2 18.5V12.5Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" />
          <path
