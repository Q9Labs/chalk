...
export interface CrownIconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const crownBodyVariants: Variants = {
  ...
  animate: {
    transform: ["translateY(0px) scale(1)", "translateY(0.35px) scale(0.992)", "translateY(-0.45px) scale(1.018)", "translateY(-0.1px) scale(1.006)", "translateY(0px) scale(1)"],
    transition: {
      duration: 0.78,
      ease: [0.77, 0, 0.175, 1],
...
const glintVariants: Variants = {
  ...
  animate: (i: number) => ({
    ...
    transform: ["scale(0.75)", "scale(0.75)", "scale(1)", "scale(0.94)", "scale(0.8)"],
    transition: {
      duration: 0.82,
      ease: [0.23, 1, 0.32, 1],
      repeat: Infinity,
...
const CrownIcon = forwardRef<CrownIconHandle, CrownIconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
  ...
  return (
    <div data-hugeicons-animated="true" className={cn("inline-flex", className)} style={{ strokeWidth: 1.5 }}>
      <svg className="h-full w-full" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" overflow="visible">
        <path d="M5 21H19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" />
        <path d="M12.125 12.75H12M12.25 12.75C12.25 12.8881 12.1381 13 12 13C11.8619 13 11.75 12.8881 11.75 12.75C11.75 12.6119 11.8619 12.5 12 12.5C12.1381 12.5 12.25 12.6119 12.25 12.75Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" />
        <motion.path
          ...
          strokeWidth="inherit"
          variants={crownBodyVariants}
          animate={controls}
          initial="normal"
          style={{ transformOrigin: "12px 12.75px" }}
        />
        <motion.g variants={generatedGeometryVariants} animate={controls} initial="normal">
          <motion.path d="M7.3 11.6V12.8M6.7 12.2H7.9" stroke="currentColor" strokeLinecap="round" strokeWidth="inherit" variants={glintVariants} custom={0} animate={controls} initial="normal" style={{ transformOrigin: "7.3px 12.2px" }} />
          <motion.path d="M16.7 11.2V12.4M16.1 11.8H17.3" stroke="currentColor" strokeLinecap="round" strokeWidth="inherit" variants={glintVariants} custom={1} animate={controls} initial="normal" style={{ transformOrigin: "16.7px 11.8px" }} />
        </motion.g>
      </svg>
    </div>
  );
