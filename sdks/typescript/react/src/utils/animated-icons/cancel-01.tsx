...
export interface Cancel01IconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const firstStrikeVariants: Variants = {
  ...
  animate: {
    ...
    transition: {
      duration: 0.9,
      ease: ["linear", [0.77, 0, 0.175, 1], "linear", "linear", "linear", [0.77, 0, 0.175, 1], "linear"],
...
const Cancel01Icon = forwardRef<Cancel01IconHandle, Cancel01IconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
  ...
  return (
    <div className={cn("inline-flex", className)} style={{ strokeWidth: 1.5 }} data-hugeicons-animated="true">
      <svg onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props} className="h-full w-full" xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" overflow="visible">
        <motion.g variants={impactVariants} animate={controls} initial="normal" style={{ transformOrigin: "12px 12px" }}>
          <motion.path d={FIRST_PATH} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" variants={firstStrikeVariants} animate={controls} initial="normal" />
          <motion.path d={SECOND_PATH} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" variants={secondStrikeVariants} animate={controls} initial="normal" />
          <motion.g variants={generatedGeometryVariants} animate={controls} initial="normal">
            <motion.path d="M6.00081 17.9992L5.1 18.9" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" variants={firstEndFlourishVariants} animate={controls} initial="normal" />
            <motion.path d="M17.9992 18L18.9 18.9008" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" variants={secondEndFlourishVariants} animate={controls} initial="normal" />
          </motion.g>
        </motion.g>
      </svg>
    </div>
