...
export interface PlayIconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const playVariants: Variants = {
  ...
  animate: {
    transform: ["translateX(0px) scaleX(1) scaleY(1)", "translateX(-0.8px) scaleX(0.9) scaleY(1.04)", "translateX(2px) scaleX(1.1) scaleY(0.97)", "translateX(-0.2px) scaleX(0.99) scaleY(1.005)", "translateX(0px) scaleX(1) scaleY(1)"],
    transition: { duration: 0.52, times: [0, 0.2, 0.52, 0.78, 1], ease: [0.23, 1, 0.32, 1] },
  },
};

const PlayIcon = forwardRef<PlayIconHandle, PlayIconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
