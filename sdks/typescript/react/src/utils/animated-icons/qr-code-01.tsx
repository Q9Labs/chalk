...
export interface QrCode01IconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const QrCode01Icon = forwardRef<QrCode01IconHandle, QrCode01IconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
    ...
    <div data-hugeicons-animated="true" className={cn("inline-flex", className)} style={{ strokeWidth: 1.5 }}>
      <svg className="h-full w-full" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" overflow="visible">
        ...
        <motion.path
          ...
          initial="normal"
        />
        <motion.path d="M6.5 13.5H8.5C9.44281 13.5 9.91421 13.5 10.2071 13.7929C10.5 14.0858 10.5 14.5572 10.5 15.5V17.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" variants={qrCellVariants} custom={2} animate={controls} initial="normal" />
        <motion.path
