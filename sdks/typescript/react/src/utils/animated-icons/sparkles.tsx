...
export interface SparklesIconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const SparklesIcon = forwardRef<SparklesIconHandle, SparklesIconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
