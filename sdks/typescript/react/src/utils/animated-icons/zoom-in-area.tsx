...
export interface ZoomInAreaIconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}
...
const ZoomInAreaIcon = forwardRef<ZoomInAreaIconHandle, ZoomInAreaIconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
    ...
    <div data-hugeicons-animated="true" className={cn("inline-flex", className)} style={{ strokeWidth: 1.5 }}>
      <svg className="h-full w-full" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" overflow="visible">
        <motion.path
          ...
          animate={controls}
          initial="normal"
          style={{ transformOrigin: "14.5px 15.1217px" }}
        />
        <motion.path d="M14.5 13.1217V17.1217M16.5 15.1217H12.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" variants={plusVariants} animate={controls} initial="normal" style={{ transformOrigin: "14.5px 15.1217px" }} />
        <path d="M10 3.62173H14M3 10.6217V14.6217M6.5 21.6217C4.567 21.6217 3 20.0547 3 18.1217M17.5 3.62173C19.433 3.62173 21 5.18873 21 7.12173M3 7.12173C3 5.18873 4.567 3.62173 6.5 3.62173" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="inherit" />
      </svg>
    </div>
  );
});
