...
export interface Settings01IconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

export interface Settings01IconProps extends SVGAttributes<SVGSVGElement> {
  size?: number | string;
}

// The outer mechanism turns and settles while the center bearing stays fixed.
...
const Settings01Icon = forwardRef<Settings01IconHandle, Settings01IconProps>(({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
  ...
  return (
    <div data-hugeicons-animated="true" className={cn("inline-flex", className)} style={{ strokeWidth: 1.5 }}>
      <svg className="h-full w-full" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" overflow="visible">
        ...
        />
        <path d="M15.5195 12C15.5195 13.933 13.9525 15.5 12.0195 15.5C10.0865 15.5 8.51953 13.933 8.51953 12C8.51953 10.067 10.0865 8.5 12.0195 8.5C13.9525 8.5 15.5195 10.067 15.5195 12Z" stroke="currentColor" strokeWidth="inherit" />
      </svg>
    </div>
  );
});
