...
export const MeetingHub = React.memo<MeetingHubProps>(({ isOpen, onClose, roomName, meetingId, meetingUrl, onCopyLink, isRecording = false, isTranscribing = false, meetingDuration = 0, stats = { latency: 28, packetLoss: 0.1, resolution: "1080p · 60fps", region: "Frankfurt, DE" }, className }) => {
