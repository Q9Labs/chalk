...
export interface IncomingMediaRequestDialogProps {
  readonly request: ChalkIncomingMediaRequest;
  readonly onDecline: () => void;
  readonly onAllow: () => void;
}

export function IncomingMediaRequestDialog({ request, onDecline, onAllow }: IncomingMediaRequestDialogProps): React.JSX.Element {
  return (
