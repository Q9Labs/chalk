...
export const MeetingHeader = React.memo<MeetingHeaderProps>(({ roomName, logoUrl, duration = 0, isRecording = false, isTranscribing = false, layout = "spotlight", onLayoutChange, onInvite, onInfo, onSettings, className }) => {
  return (
        ...
        {onLayoutChange && (
          <div className="hidden gap-0.5 rounded-[9px] bg-[#f0efeb] p-1 sm:flex" role="group" aria-label="Video layout">
            <button
              ...
              className={cn("grid h-8 w-8 place-items-center rounded-[6px] text-[#6d727b] transition", layout === "spotlight" ? "bg-white text-[#202329] shadow-[0_1px_2px_rgba(12,14,18,0.08)]" : "hover:text-[#202329]")}
            ...
            <button
              ...
              className={cn("grid h-8 w-8 place-items-center rounded-[6px] text-[#6d727b] transition", layout === "sidebar" ? "bg-white text-[#202329] shadow-[0_1px_2px_rgba(12,14,18,0.08)]" : "hover:text-[#202329]")}
