...
const SettingsPanelSurface = React.memo(
  ({
    ...
    return (
      <ChalkDialogPanel className={cn("flex flex-col h-full w-80 shadow-xl", "bg-[var(--chalk-surface)]", "border-l border-[var(--chalk-line)]", className)} data-tour="settings-panel" role="dialog" aria-label="Settings" style={themeVariables as React.CSSProperties}>
