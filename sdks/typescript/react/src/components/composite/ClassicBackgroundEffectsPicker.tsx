...
import type { BackgroundEffectsPickerProps } from "./BackgroundEffectsPicker";

export const ClassicBackgroundEffectsPicker = React.memo(({ effects, selectedEffectId, onSelect, onCustomUpload, disabled = false, participantColorSeed, participantGradientPreference, className }: BackgroundEffectsPickerProps) => {
...
ClassicBackgroundEffectsPicker.displayName = "BackgroundEffectsPicker";
