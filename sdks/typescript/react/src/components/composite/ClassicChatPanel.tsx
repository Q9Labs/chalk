...
export interface ClassicChatPanelSurfaceProps extends ChatPanelProps {
...
export const ClassicChatPanelSurface = React.memo(
  ({
    messages,
    pendingMessages = [],
    readReceipts = [],
