...
import type { ScreenShareViewProps } from "./ScreenShareView";
...
export function ClassicScreenShareView(props: ScreenShareViewProps): React.JSX.Element {
...
ClassicScreenShareView.displayName = "ClassicScreenShareView";
