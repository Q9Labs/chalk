...
import type { DeviceSelectorProps } from "./DeviceSelector";
...
export const ClassicDeviceSelector = React.memo(({ type, devices, selectedDeviceId, onChange, label, previewTrack, audioLevel, disabled = false, participantColorSeed, participantGradientPreference, className }: DeviceSelectorProps) => {
...
ClassicDeviceSelector.displayName = "DeviceSelector";
