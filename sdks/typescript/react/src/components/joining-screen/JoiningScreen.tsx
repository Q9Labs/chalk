...
function JoiningScreenBase({ message = "Loading...", className, displayName = "Chalk User", supportingMessages = EMPTY_SUPPORTING_MESSAGES, gradientPreference }: JoiningScreenProps): React.JSX.Element {
...
export const JoiningScreen = memo(JoiningScreenBase);
JoiningScreen.displayName = "JoiningScreen";
