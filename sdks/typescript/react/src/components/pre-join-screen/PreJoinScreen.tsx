...
export function PreJoinScreen({ roomName = "Chalk room", logoUrl, defaultDisplayName = "", initialMicrophoneEnabled = true, initialCameraEnabled = true, isJoining = false, error, onJoin, className }: PreJoinScreenProps): React.JSX.Element {
