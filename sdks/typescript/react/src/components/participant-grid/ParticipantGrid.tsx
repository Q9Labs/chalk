...
export const ParticipantGridSurface = React.memo(function ParticipantGridSurface({ participants, layout = "grid", variant, pinnedParticipantId, onParticipantClick, onParticipantDoubleClick, maxVisibleParticipants, className }: ParticipantGridSurfaceProps) {
