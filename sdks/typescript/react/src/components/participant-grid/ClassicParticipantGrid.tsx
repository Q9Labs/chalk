...
import type { Participant, ParticipantGridProps } from "./ParticipantGrid";

interface ParticipantGridSurfaceProps extends ParticipantGridProps {
  readonly participants: Participant[];
}

export function ClassicParticipantGrid(props: ParticipantGridProps): React.JSX.Element {
  const self = useSelf();
...
ClassicParticipantGrid.displayName = "ClassicParticipantGrid";
