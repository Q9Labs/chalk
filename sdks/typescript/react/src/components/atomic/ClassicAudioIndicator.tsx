...
export const ClassicAudioIndicator = React.memo(({ level = 0, muted = false, size = "md", variant = "icon", className }: AudioIndicatorProps) => {
...
ClassicAudioIndicator.displayName = "ClassicAudioIndicator";
