...
import type { CaptionLineProps } from "./CaptionLine";

export const ClassicCaptionLine = React.memo<CaptionLineProps>(({ text, speaker, position = "bottom", maxLines = 2, className }) => {
  if (!text) return null;
...
ClassicCaptionLine.displayName = "CaptionLine";
