...
export const ClassicHandRaiseIndicator = React.memo(({ raised, animated = true, position = "top-right", size = "md", className }: HandRaiseIndicatorProps) => {
...
ClassicHandRaiseIndicator.displayName = "ClassicHandRaiseIndicator";
