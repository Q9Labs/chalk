...
import { getParticipantAvatarRecipe } from "../../utils/colorGenerator";
...
export const ClassicAvatar = React.memo(({ name, src, size = "md", status, className, style, gradientPreference, generated = true, animated = true }: AvatarProps) => {
