...
export const ClassicWaveform = React.memo(({ levels, color = "var(--chalk-focus)", animated = true, barCount = 5, className }: WaveformProps) => {
...
ClassicWaveform.displayName = "ClassicWaveform";
