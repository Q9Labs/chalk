...
import type { ReleaseBadgeProps } from "./ReleaseBadge";
...
export const ClassicReleaseBadge = React.memo<ReleaseBadgeProps>(({ type, className }) => {
...
ClassicReleaseBadge.displayName = "ClassicReleaseBadge";
