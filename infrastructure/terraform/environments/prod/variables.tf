...
variable "manage_dns_records" {
  description = "Manage API/WebSocket DNS records from this stack"
  type        = bool
  default     = true
}
...
variable "ops_ingest_token" {
  description = "Ops monitor ingest token"
  type        = string
  sensitive   = true
  default     = ""
}

variable "ops_whatsapp_enabled" {
  description = "Enable WhatsApp notifications for ops incidents"
  type        = bool
  default     = false
}

variable "ops_twilio_account_sid" {
  description = "Twilio account SID for ops WhatsApp notifications"
  type        = string
  sensitive   = true
  default     = ""
}

variable "ops_twilio_auth_token" {
  description = "Twilio auth token for ops WhatsApp notifications"
  type        = string
  sensitive   = true
  default     = ""
}

variable "ops_twilio_whatsapp_from" {
  description = "Twilio WhatsApp sender for ops notifications"
  type        = string
  default     = ""
}

variable "ops_whatsapp_to_critical" {
  description = "Comma-separated critical WhatsApp recipients"
  type        = string
  default     = ""
}

variable "ops_whatsapp_to_major" {
  description = "Comma-separated major WhatsApp recipients"
  type        = string
  default     = ""
}

variable "ops_public_status_base_url" {
  description = "Public status page URL used in ops notifications"
  type        = string
  default     = ""
}
