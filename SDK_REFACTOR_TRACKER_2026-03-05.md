...
- `2026-03-06 00:08 PKT`: produced `sdk-core` variant decision report (`SDK_VARIANT_DECISION_REPORT_2026-03-06.md`) with canonical picks: keep `token.expired`, keep whiteboard wire v2 as outbound canonical, keep dot-notation WS contracts, keep `token/tokenProvider` auth (deprecate `apiKey`).
